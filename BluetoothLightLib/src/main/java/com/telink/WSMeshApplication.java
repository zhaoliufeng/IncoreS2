...
public class WSMeshApplication extends Application {

    private static WSMeshApplication mThis;
    ...
    protected final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            WSMeshApplication.this.onServiceConnected(name, service);
        }

        @Override
        public void onServiceDisconnected(ComponentName name) {
            WSMeshApplication.this.onServiceDisconnected(name);
        }
    };
    ...
    public static WSMeshApplication getInstance() {
        if (mThis == null)
            mThis = new WSMeshApplication();
        return mThis;
    }
    ...
    public void onCreate() {
        ...
        this.mContext = this;
        super.onCreate();
        WeSmartLog.d("WSMeshApplication Created.");
    }
    ...
    protected void onServiceConnected(ComponentName name, IBinder service) {
        ...
        WeSmartLog.d("service connected --> " + name.getShortClassName());
    ...
    protected void onServiceDisconnected(ComponentName name) {
        ...
        WeSmartLog.d("service disconnected --> " + name.getShortClassName());
