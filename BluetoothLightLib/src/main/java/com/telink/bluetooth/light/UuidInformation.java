...
public enum UuidInformation {
    ...
    WESMART_BEACON(UUID.fromString("0000fef1-0000-1000-8000-00805f9b34fb"), "Beacon"),
    ...
    CHARACTERISTIC_BEACON(UUID.fromString("00008007-0000-1000-8000-00805f9b34fb"), "Tmall Password"),
    CHARACTERISTIC_(UUID.fromString("00002a24-0000-1000-8000-00805f9b34fb"), "Model Number"),
