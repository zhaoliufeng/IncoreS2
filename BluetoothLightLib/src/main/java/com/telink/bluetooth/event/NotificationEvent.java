...
public class NotificationEvent extends DataEvent<NotificationInfo> {
     ...
     * 获取设备类型
     */
    public static final String GET_DEVICE_TYPE = "com.telink.bluetooth.light.GET_DEVICE_TYPE";
    /**
     * 获取颜色值
     */
    public static final String GET_COLOR = "com.telink.bluetooth.light.EVENT_GET_COLOR";
    /**
     * 获取版本号
     */
    public static final String GET_FIRMWARE = "com.telink.bluetooth.light.EVENT_GET_FIRMWARE";
    ...
    static {
        ...
        register(Opcode.BLE_GATT_OP_CTRL_DB,GET_COLOR);
        register(Opcode.BLE_GATT_OP_CTRL_EB,GET_DEVICE_TYPE);
        register(Opcode.BLE_GATT_OP_CTRL_C8,GET_FIRMWARE);
    }
