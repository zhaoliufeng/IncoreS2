...
public class Peripheral extends BluetoothGattCallback {
    ...
    public void connect(Context context) {
        ...
        synchronized (this.mStateLock) {
            ...
            if (this.mConnState == CONN_STATE_IDLE) {
                WeSmartLog.d("connect " + this.getDeviceName() + " -- "
                        + this.getMacAddress());
    ...
    public void disconnect() {
        ...
        WeSmartLog.d("disconnect " + this.getDeviceName() + " -- "
                + this.getMacAddress());
    ...
    private void processCommand() {
        WeSmartLog.d("processing : " + this.processing);
    ...
    synchronized private void processCommand(CommandContext commandContext) {
        ...
        WeSmartLog.d("processCommand : " + command.toString());
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status,
                                        int newState) {
        WeSmartLog.d("onConnectionStateChange  status :" + status + " state : "
                + newState);
        ...
        if (newState == BluetoothGatt.STATE_CONNECTED) {
            ...
            if (this.gatt == null || !this.gatt.discoverServices()) {
                WeSmartLog.d("remote service discovery has been stopped status = "
                        + newState);
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt,
        ...
        Log.i("TestData", Hex.encodeHexStr(characteristic.getValue()));
    ...
    public void onCharacteristicWrite(BluetoothGatt gatt,
        ...
        WeSmartLog.d("onCharacteristicWrite newStatus : " + status);
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        if (status == BluetoothGatt.GATT_SUCCESS) {
            ...
            WeSmartLog.d("Service discovery failed");
            this.disconnect();
        }
    }
