...
public class EventBus<T> {
    ...
    public void dispatchEvent(final Event<T> event) {
        WeSmartLog.d("event looper : " + event.getThreadMode());

        this.mEventQueue.add(event);

        WeSmartLog.d("postCommand event : " + event.getType() + "--" + event.getClass().getName());
    ...
    private void processEvent() {
        WeSmartLog.d("process on thread : " + Thread.currentThread().getName());
        ...
        WeSmartLog.d("process postCommand event : " + event.getType() + "--" + event.getClass().getName());
